...
class _CatProductosScreenState extends State<CatProductosScreen> {
  ...
  static const List<_Categoria> _categorias = [
    ...
    _Categoria(nombre: 'Herramientas',  cantidad: 18, icono: Icons.construction_rounded),
    _Categoria(nombre: 'Protección',    cantidad: 32, icono: Icons.shield_outlined),
    _Categoria(nombre: 'Interruptores', cantidad: 15, icono: Icons.toggle_on_rounded),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => ProductosScreen(
                      categoria: _filtradas[index].nombre,
                    ),
                  ),
                );
              },
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(categoria.icono, color: AppTheme.primary, size: 28),
              ),
              const Spacer(),
              Text(
                categoria.nombre,
